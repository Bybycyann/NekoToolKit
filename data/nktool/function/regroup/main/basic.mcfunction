...
execute store success storage nktool:array input.temp byte 1 run data modify storage nktool:array input.source[0] set from storage nktool:array input.condition
#剔除 source[0]
